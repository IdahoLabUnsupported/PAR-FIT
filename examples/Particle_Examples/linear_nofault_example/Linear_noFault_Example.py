# -*- coding: utf-8 -*-
"""
Created on Tue Mar 10 12:48:52 2026
...
if __name__ == "__main__":
    ...
    signal_part1 = np.random.normal(loc=35,scale=1, size=(100,3))
    signal_part2 = np.random.normal(loc=0,scale=1, size=(100,3))
    signal_part3 = np.linspace(start=35, stop=85, num=100)
    signal_part3 = signal_part2 + signal_part3[:, None] 
    signal_part4 = np.random.normal(loc=85,scale=1, size=(100,3))
    measured_signal = np.vstack((signal_part1,signal_part3))
    measured_signal = np.vstack((measured_signal,signal_part4))
