# -*- coding: utf-8 -*-
"""
Created on Mon Mar  9 15:25:34 2026
...
if __name__ == "__main__":
    ...
    measured_signal = np.random.normal(loc=42,scale=1, size=(100,3))
    ...
    for col in COLS:
        ...
        # Labels and legend
        plt.title(f"Mean and Std.D for {col}; Scoring ({SCORING}); Weighting ({WEIGHTING}); Resample ({RESAMP}); Cutoff ({CUTOFF})", wrap=True, fontsize=10)
